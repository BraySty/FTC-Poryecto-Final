...
public class UsuarioController {
	 ...
	 * @return ResponseEntity<> con el estado de la operacion.
	 */
	@PutMapping(BASE_URL + "/{correo}/{password}")
	ResponseEntity<Mensaje> update(@PathVariable("correo") String correoUsuario,
			@PathVariable("password") String passwordUsuario, @RequestBody Usuario usuario) {
